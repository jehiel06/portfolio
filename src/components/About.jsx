...
const TechCard = ({ tech, index }) => {
    ...
    return (
        <motion.div
            className="group relative bg-black border border-gray-900 rounded-xl p-4 hover:border-orange-500/30 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-orange-500/20 cursor-pointer overflow-hidden"
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center gap-3">
                <div className={`text-4xl ${tech.color} group-hover:scale-125 transition-transform duration-300`}>
                    {tech.icon}
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="space-y-8">
                    ...
                    >
                        ...
                        <h3 className="text-xl sm:text-2xl text-orange-500 font-medium">
                    ...
                    >
                        <div className="bg-black border border-gray-900 rounded-xl p-6 hover:border-orange-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/10">
                            <FaGraduationCap className="text-orange-500 text-3xl mb-3" />
                            <h4 className="text-white text-lg font-semibold mb-2">Education</h4>
                            <p className="text-gray-300 text-sm">B.E Computer Science and Engineering</p>
                            <p className="text-orange-500 text-sm font-medium">Sri Ramakrishna Engineering College</p>
                            <p className="text-gray-400 text-xs mt-1">Coimbatore, Tamil Nadu</p>
                        </div>

                        <div className="bg-black border border-gray-900 rounded-xl p-6 hover:border-orange-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/10">
                            <FaAward className="text-orange-500 text-3xl mb-3" />
                            <h4 className="text-white text-lg font-semibold mb-2">Focus Areas</h4>
                            <p className="text-gray-300 text-sm">Full Stack Development</p>
                            <p className="text-gray-300 text-sm">Java & Spring Boot Ecosystem</p>
                    ...
                    >
                        <div className="bg-black border border-gray-900 rounded-xl p-6 hover:border-orange-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/10">
                            <FaCode className="text-orange-500 text-4xl mb-4" />
                            <h4 className="text-white text-xl font-semibold mb-2">Backend Development</h4>
                            <p className="text-gray-400 text-sm">Building robust REST APIs and microservices with Java, Spring Boot, and MongoDB</p>
                        </div>

                        <div className="bg-black border border-gray-900 rounded-xl p-6 hover:border-orange-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/10">
                            <FaLaptopCode className="text-orange-500 text-4xl mb-4" />
                            <h4 className="text-white text-xl font-semibold mb-2">Frontend Development</h4>
                            <p className="text-gray-400 text-sm">Creating responsive, modern UIs with React.js, Tailwind CSS, and modern JavaScript</p>
                        </div>

                        <div className="bg-black border border-gray-900 rounded-xl p-6 hover:border-orange-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/10">
                            <FaRocket className="text-orange-500 text-4xl mb-4" />
                            <h4 className="text-white text-xl font-semibold mb-2">Problem Solving</h4>
                            <p className="text-gray-400 text-sm">Tackling complex challenges with efficient algorithms, data structures, and best practices</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-6">
                            <a
                                ...
                                className="flex items-center gap-2 text-gray-300 hover:text-orange-500 transition-colors duration-300 group"
                            >
                            ...
                            <a
                                ...
                                className="flex items-center gap-2 text-gray-300 hover:text-orange-500 transition-colors duration-300 group"
                            >
                                <FaGithub className="w-5 h-5 group-hover:scale-125 transition-transform" />
                            ...
                            <a
                                ...
                                className="flex items-center gap-2 text-gray-300 hover:text-orange-500 transition-colors duration-300 group"
                            >
                                <FaEnvelope className="w-5 h-5 group-hover:scale-125 transition-transform" />
                                <span className="text-sm">jehiel06.dev@gmail.com</span>
                            </a>
                        </div>
                    </motion.div>
                </div>
